...
## 12. Stage 02 장소 이전 예외

Stage 01의 정산에서는 일반적인 `새벽 장보기로` 외에 500문짜리 새 장소 구매를 선택할 수 있다. 구매하면 새벽으로 가지 않고 Stage 02 Day 1 아침 영업을 시작한다.

- 메뉴 해금과 메뉴 레벨만 유지한다.
- 돈, 좌석, 직원·주급, 재고, 날짜, Stage 누적 기록과 진행 중 작업은 초기화한다.
- 새 장소의 시작 지급으로 밥 20인분과 고등어 20인분을 제공한다.
- Stage 02부터는 다시 일반 `정산 → 새벽 시장 → 준비 → 다음 날` 순서를 따른다.
